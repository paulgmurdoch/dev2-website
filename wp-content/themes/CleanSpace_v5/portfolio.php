...
?>
    ...
    <div class="work-box itope <?php unset($term_links);
					$sPattern = '/\s*/m';
					$sReplace = '';
      ...
      <div class="img-frame"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" data-rel="#olay<?php echo $count; ?>">
        <?php the_post_thumbnail('Portfolio 3 Pic'); ?>
        </a></div>
      <?php } else { echo '<div class="img-frame"><img src="'.get_bloginfo("template_url").'/images/img-portfolio3-default.png" /></div>';
}?>
